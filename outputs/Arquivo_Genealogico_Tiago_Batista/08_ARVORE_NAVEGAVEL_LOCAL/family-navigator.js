...
(function () {
  ...
  const relations = {
    ...
    'maria-carmo':{parents:['joao-vitorino','maria-benedita-vitorino'],children:['tiago','taina-batista','diego-batista','tatiana-batista'],siblings:['antonio-vitorino','abadia-vitorino','aparecida-max','cleusa-porcina'],spouse:['ivanildo']},
    jose:{parents:['joventino','maria-joaquina'],children:['everaldo','ivan','ivanildo','ivaneth','ivanize','edson'],siblings:['donzilia','romeu-pereira','elisa-pereira','horacio-candidato'],spouse:['iraci']},
    iraci:{parents:['antonio','maria-joana'],children:['everaldo','ivan','ivanildo','ivaneth','ivanize','edson'],siblings:['helena-irma-iraci','nana-irma-iraci','jose-batista-candidato'],spouse:['jose']},
    ...
    'romeu-pereira':{parents:['joventino','maria-joaquina'],children:[],siblings:['jose','donzilia','elisa-pereira','horacio-candidato'],spouse:[]},
    'elisa-pereira':{parents:['joventino','maria-joaquina'],children:[],siblings:['jose','donzilia','romeu-pereira','horacio-candidato'],spouse:[]},
    'horacio-candidato':{parents:['joventino','maria-joaquina'],children:[],siblings:['jose','donzilia','romeu-pereira','elisa-pereira'],spouse:[]},
    ...
    'joao-vitorino':{parents:['firmino-jose-candidato','maria-francisca-motta-candidata'],children:['maria-carmo'],siblings:[],spouse:['maria-benedita-vitorino']},
    'maria-benedita-vitorino':{parents:['joao-belisario','prudenciana'],children:['maria-carmo'],siblings:[],spouse:['joao-vitorino']},
    'firmino-jose-candidato':{parents:[],children:['joao-vitorino'],siblings:[],spouse:['maria-francisca-motta-candidata']},
    'maria-francisca-motta-candidata':{parents:[],children:['joao-vitorino'],siblings:[],spouse:['firmino-jose-candidato']},
    'joao-belisario':{parents:[],children:['maria-benedita-vitorino'],siblings:[],spouse:['prudenciana']},
    prudenciana:{parents:[],children:['maria-benedita-vitorino'],siblings:[],spouse:['joao-belisario']},
    'jose-batista-candidato':{parents:['antonio','maria-joana'],children:[],siblings:['iraci','helena-irma-iraci','nana-irma-iraci'],spouse:[]},
